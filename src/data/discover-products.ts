export type DiscoverPath = "sell" | "swap" | "donate" | "repair" | "parts";
...
export const discoverProducts: DiscoverProduct[] = [
  ...
  },
  {
    ...
    title: "Kursi Kerja Ergonomis Mesh Sandaran Tinggi",
    image:
    ...
    detail: "Roda dan sandaran normal",
    price: 850000,
    carbonKg: 12.3,
    logistics: "Hub Tebet (0,9 km)",
    actionLabel: "Cek Audit AI",
  },
  {
    id: "meja-lipat-belajar",
    title: "Meja Lipat Belajar Kayu Multipleks 80x50",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuAiHK34Habb8AELrl8rrkO8_Z7FX4nUzOg1D1fM_i_6POatyDtAOHFN0CrJcDiXnuyhAa42xDLK28FR4m1hzZkYrpxcwsaslx9Fd2hRvxjRBZ7TCKClCQFrahmiq8tgZayPnTC9fyAJ2Esxu6NezmvcyArSUCwfDBv-npOSNUniNbAHvsTPg79ZdxFGUuC4hDtctTrBecIim7BL0OynRe-sZbiAcmj8pepha-rQ_zJtJgSFw-NEavMu",
    path: "donate",
    pathLabel: "Donasi",
    category: "furniture",
    score: 64,
    condition: "Cukup, Baret Ringan",
    detail: "Engsel lipat masih kuat",
    price: 0,
    carbonKg: 9.1,
    logistics: "Ambil di Hub Kuningan",
    actionLabel: "Ajukan Donasi",
  },
  {
    id: "rak-buku-modular",
    title: "Rak Buku Modular 5 Susun Besi Minimalis",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuAiHK34Habb8AELrl8rrkO8_Z7FX4nUzOg1D1fM_i_6POatyDtAOHFN0CrJcDiXnuyhAa42xDLK28FR4m1hzZkYrpxcwsaslx9Fd2hRvxjRBZ7TCKClCQFrahmiq8tgZayPnTC9fyAJ2Esxu6NezmvcyArSUCwfDBv-npOSNUniNbAHvsTPg79ZdxFGUuC4hDtctTrBecIim7BL0OynRe-sZbiAcmj8pepha-rQ_zJtJgSFw-NEavMu",
    path: "sell",
    pathLabel: "Jual Langsung",
    ...
    score: 81,
    condition: "Sangat Baik",
    detail: "Tanpa karat, baut lengkap",
    price: 420000,
    carbonKg: 15.6,
    logistics: "Hub Senopati (2,1 km)",
    actionLabel: "Cek Audit AI",
  },
  {
    id: "tas-ransel-sekolah",
    title: "Tas Ransel Sekolah Anti Air 30L",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuAiHK34Habb8AELrl8rrkO8_Z7FX4nUzOg1D1fM_i_6POatyDtAOHFN0CrJcDiXnuyhAa42xDLK28FR4m1hzZkYrpxcwsaslx9Fd2hRvxjRBZ7TCKClCQFrahmiq8tgZayPnTC9fyAJ2Esxu6NezmvcyArSUCwfDBv-npOSNUniNbAHvsTPg79ZdxFGUuC4hDtctTrBecIim7BL0OynRe-sZbiAcmj8pepha-rQ_zJtJgSFw-NEavMu",
    path: "swap",
    pathLabel: "Tukar Tambah",
    ...
    score: 79,
    condition: "Sangat Baik",
    detail: "Resleting dan jahitan kuat",
    price: 180000,
    carbonKg: 3.2,
    logistics: "Locker Dukuh Atas",
    actionLabel: "Ajukan Barter",
  ...
  {
    id: "kalkulator-scientific",
    title: "Kalkulator Scientific Casio fx-991 Bekas",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuAiHK34Habb8AELrl8rrkO8_Z7FX4nUzOg1D1fM_i_6POatyDtAOHFN0CrJcDiXnuyhAa42xDLK28FR4m1hzZkYrpxcwsaslx9Fd2hRvxjRBZ7TCKClCQFrahmiq8tgZayPnTC9fyAJ2Esxu6NezmvcyArSUCwfDBv-npOSNUniNbAHvsTPg79ZdxFGUuC4hDtctTrBecIim7BL0OynRe-sZbiAcmj8pepha-rQ_zJtJgSFw-NEavMu",
    path: "sell",
    pathLabel: "Jual Langsung",
  ...
  {
    id: "alat-tulis-set-parts",
    title: "Set Suku Cadang Printer Label Belajar",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuAiHK34Habb8AELrl8rrkO8_Z7FX4nUzOg1D1fM_i_6POatyDtAOHFN0CrJcDiXnuyhAa42xDLK28FR4m1hzZkYrpxcwsaslx9Fd2hRvxjRBZ7TCKClCQFrahmiq8tgZayPnTC9fyAJ2Esxu6NezmvcyArSUCwfDBv-npOSNUniNbAHvsTPg79ZdxFGUuC4hDtctTrBecIim7BL0OynRe-sZbiAcmj8pepha-rQ_zJtJgSFw-NEavMu",
    path: "parts",
    pathLabel: "Suku Cadang",
    category: "study",
    score: 45,
    condition: "Untuk Suku Cadang",
    detail: "Motor macet, roller masih baik",
    price: 60000,
    carbonKg: 1.1,
    logistics: "Hub Tebet (0,9 km)",
    actionLabel: "Cek Ketersediaan",
  },
  {
    id: "sprei-set-katun",
    title: "Sprei Set Katun 160x200 Motif Polos",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuAiHK34Habb8AELrl8rrkO8_Z7FX4nUzOg1D1fM_i_6POatyDtAOHFN0CrJcDiXnuyhAa42xDLK28FR4m1hzZkYrpxcwsaslx9Fd2hRvxjRBZ7TCKClCQFrahmiq8tgZayPnTC9fyAJ2Esxu6NezmvcyArSUCwfDBv-npOSNUniNbAHvsTPg79ZdxFGUuC4hDtctTrBecIim7BL0OynRe-sZbiAcmj8pepha-rQ_zJtJgSFw-NEavMu",
    path: "donate",
    pathLabel: "Donasi",
    ...
    score: 70,
    condition: "Kondisi Baik",
    detail: "Sudah dicuci bersih",
    price: 0,
    carbonKg: 4.5,
    logistics: "Ambil di Hub Senopati",
    actionLabel: "Ajukan Donasi",
  },
  {
    id: "karpet-anak-lipat",
    title: "Karpet Anak Lipat Anti Slip 150x200",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuAiHK34Habb8AELrl8rrkO8_Z7FX4nUzOg1D1fM_i_6POatyDtAOHFN0CrJcDiXnuyhAa42xDLK28FR4m1hzZkYrpxcwsaslx9Fd2hRvxjRBZ7TCKClCQFrahmiq8tgZayPnTC9fyAJ2Esxu6NezmvcyArSUCwfDBv-npOSNUniNbAHvsTPg79ZdxFGUuC4hDtctTrBecIim7BL0OynRe-sZbiAcmj8pepha-rQ_zJtJgSFw-NEavMu",
    path: "sell",
    pathLabel: "Jual Langsung",
    category: "textile",
    score: 73,
    condition: "Baik, Sedikit Pudar",
    detail: "Bebas bau dan noda",
    price: 210000,
    carbonKg: 3.8,
    logistics: "Hub Kuningan (3,5 km)",
    actionLabel: "Cek Audit AI",
